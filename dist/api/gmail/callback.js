...
import { verifyOAuthState, exchangeCodeForTokens, getGmailProfile, storeOAuthTokens } from '../lib/gmail.js';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const { id: tokenId } = await storeOAuthTokens(userId, emailAccountId, profile.email, tokens);
