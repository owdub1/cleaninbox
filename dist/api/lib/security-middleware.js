 ...
 */
export function validateContentType(req, res, expectedType = 'application/json') {
 ...
 */
export function validateRequestSize(req, res, maxSizeKB = 100) {
...
export function securityChecks(req, res, options = {}) {
    const { allowedMethods = ['GET', 'POST', 'PUT', 'DELETE'], requireContentType, maxSizeKB = 100, validateOrigin: checkOrigin = true } = options;
 ...
 */
export function sanitizeRequestBody(body, maxDepth = 5) {
    if (maxDepth === 0)
        return body;
