...
export function useSubscription() {
  ...
  return {
    ...
    isPaid: subscription.plan.toLowerCase() !== 'free' && subscription.status !== 'expired',
    hasFullTools: ['pro', 'unlimited', 'onetime'].includes(subscription.plan.toLowerCase()) && subscription.status !== 'expired',
